...
// @match        *://*.duolingo.com/*
// @match        *://*.duolingo.cn/*
// @match        *://duolingo-helper.onrender.com/*
...
// @connect      duolingo-helper.onrender.com
...
// @downloadURL  https://duolingo-helper.onrender.com/DuolingoHelper.user.js
// @updateURL    https://duolingo-helper.onrender.com/DuolingoHelper.user.js
// @grant        GM_log
// @grant        GM_cookie
// @grant        GM_setValue
// @grant        GM_getValue
...
const VERSION_NUMBER = "111";
const STORAGE_LOCAL_VERSION = "1";
const STORAGE_SESSION_VERSION = "1";
const VERSION_NAME = "1.1.1";
const VERSION_FULL = "1.1.1";
const VERSION_FORMAL = "1.1.1";
let serverURL = "https://duolingo-helper.onrender.com";
let apiURL = "https://duolingo-helper.onrender.com";
let autoServerURL = "https://duolingo-helper.onrender.com";
const LOGIN_PAGE_URL = "https://duolingo-helper.onrender.com";
...
const systemText = {
    en: {
        ...
        requests: {
            xpPrompt: "你想获取多少经验？",
            gemsPrompt: "你想获取多少宝石？",
            superPrompt: "你想兑换 3 天 Super Duolingo 吗？",
            xpBoostPrompt: "你想兑换一次经验加速吗？",
            streakFreezesPrompt: "你想获取多少个连续天数保护？",
            streakDaysPrompt: "你想增加几天连续天数？",
            heartRefillPrompt: "你想将心心补充到满吗？",
            questsPrompt: "你想完成所有任务吗？",
            enableLocalMaxPrompt: "你想启用本地 Duolingo Max 吗？",
            monthlyBadgePrompt: "你想获取哪个月度徽章？",
        },
        terms: {
            title: "服务条款",
            intro: "请阅读并接受服务条款后使用 更好的多邻国 1.0。",
            acceptedIntro: "这些是你已同意使用 更好的多邻国 1.0 的服务条款。",
            loading: "正在加载服务条款<br><br>在服务条款加载完成之前无法使用本软件",
            required: "不接受服务条款则无法使用 更好的多邻国 1.0。",
            updateNotice: "我们更新了服务条款，请仔细阅读并接受以继续使用 更好的多邻国 1.0。"
        },
        settings: {
            title: "设置",
            automaticUpdates: "自动更新",
            automaticUpdatesDescription: "当有新版本时 更好的多邻国 1.0 会自动更新。",
            savingAndApplying: "正在保存并应用",
            showSolveButtons: "显示解题按钮",
            showSolveButtonsDescription: "在课程和练习中显示「解题」和「全部解题」按钮。",
            showAutoServerButton: "显示 AutoServer 按钮",
            showAutoServerButtonDescription: "在 Duolingo 菜单栏显示 AutoServer 按钮。",
            helpImproveTitle: "帮助我们改进 更好的多邻国",
            helpImproveDescription: "允许 更好的多邻国 收集匿名使用数据以帮助我们改进脚本。",
            helpImproveOnboardingDescription: "允许 更好的多邻国 自动发送匿名错误报告和使用数据以帮助我们改进脚本。",
            reduceEffects: "减少特效",
            reduceEffectsDescription: "通过禁用纸屑、星空和其他视觉动画来减少处理器密集型效果。",
            freeLocalMax: "免费本地 Duolingo Max",
            freeLocalMaxDescription: "无需担心心心用完，免费进入传奇挑战、个性化练习和无广告学习。仅在本地有效。",
            showSuperTrial: "显示 Super Duolingo 试用功能",
            showSuperTrialDescription: "此功能很少生效且正在逐步淘汰。建议使用免费 Duolingo Max 代替。",
        },

        onboarding: {
            welcome: "欢迎使用",
            description: "跳过繁琐的练习，直接获取经验、宝石、连续天数奖励、自动解题等功能。",
            modeDescription: "通过服务器端快速获取奖励，课程自动解答。",
            maxCardTitle: "Duolingo Max",
            maxCardBody: "无需担心心心用完，免费进入传奇挑战、个性化练习和无广告学习。如已有 Super 或 Max 请勿开启。"
        },
        solver: {
            solve: "解题",
            solveAll: "全部解题",
            ...
            playAll: "全部播放",
            pausePlay: "暂停播放",
            chessStartPlaying: "开始下棋",
            chessStopPlaying: "停止下棋",
            chessApiErrorStatus: "API 错误！状态码：{status}",
            chessBoardNotFound: "无法在画布上找到棋盘。",
            chessCanvasNotFound: "未找到画布。",
            chessCurrentFenUnavailable: "无法提取当前棋局的 FEN。",
            chessLessonCorrectMovesEmpty: "国际象棋课程的正确走法为空。",
            chessLessonCorrectMovesMissing: "未找到国际象棋课程的正确走法。",
            chessLessonCurrentMovesDiverged: "国际象棋课程的当前走法与预期解法路线不一致。",
            chessMovesUnavailable: "无法提取棋局走法。",
        },
        notifications: {
            featureDisabledTitle: "功能已禁用",
            featureDisabledBody: "当前服务器已禁用此功能。",
            connectionErrorTitle: "连接错误",
            connectionErrorBody: "无法连接到服务器 请稍后再试，加入我们的 QQ : 1014139027 以寻求支持",
            updateRequiredTitle: "需要更新",
            updateRequiredBody: "你当前的 DuolingoHelper 版本已过时，部分功能可能无法使用。请<a href='https://duolingo-helper.onrender.com/DuolingoHelper.user.js' target='_blank' class='DLP_Link_Style_1'>更新脚本</a>。",
            multipleScriptsTitle: "检测到多个脚本",
            multipleScriptsBody: "检测到页面中加载了多个 更好的多邻国 脚本实例。请禁用多余的脚本以避免冲突。",
            pinLimitReachedTitle: "已达到置顶上限",
            pinLimitReachedBody: "您已达到最大置顶项目数量。请先取消一些已有置顶后再试。",
            solvedIncorrectlyTitle: "答错了",
            solvedIncorrectlyBody: "题目回答错误。已生成错误报告，ID：{id}",
            stuckTitle: "答题卡住",
            stuckBody: "脚本在该题目上卡住了。已生成错误报告，ID：{id}",
            sendFailedTitle: "发送失败",
            sendFailedBody: "无法确认消息是否已送达。请重试。",
            xpTooHighTitle: "经验值过高",
            xpTooHighBody: "你即将获得超过推荐量的经验值。点击「确认」继续。",
            solvedIncorrectlyNoAnalyticsBody: "题目回答错误。请在设置中开启匿名使用数据分享以帮助我们修复此问题。",
            stuckNoAnalyticsBody: "脚本在该题目上卡住了。请在设置中开启匿名使用数据分享以帮助我们修复此问题。",
        },
        
        stats: {
            modernTitle: VERSION_NAME + " 统计",
            xpGained: "获得经验：",
            gemsGained: "获得宝石：",
            streakGained: "获得连续天数：",
            heartRefillsRequested: "心心补充次数：",
            streakFreezesRequested: "连续天数保护次数：",
            doubleXpBoostsRequested: "双倍经验加速次数：",
            questCompletesRequested: "任务完成次数：",
            since: "自 {date} 起"
        },
        autoserver: {
            title: "AutoServer",
            ...
            underConstructionBody: "AutoServer 目前处于建设阶段，暂时无法使用。感谢您的耐心，我们将持续更新进度。",
            settingsUnavailableTitle: "AutoServer 设置不可用",
            settingsUnavailableBody: "AutoServer 未返回所需的连续天数设置。请稍后再试。",
            updateFailedTitle: "AutoServer 更新失败",
            updateFailedBody: "无法保存您的连续天数设置。",
            missingToken: "未找到 Duolingo 登录令牌。",
            requestFailed: "AutoServer 请求失败。",
            streakUiUnavailable: "AutoServer 连续天数 UI 设置不可用。",
            streakSettingsUnavailable: "AutoServer 连续天数设置不可用。",
            streakDataMissing: "未返回连续天数设置。",
            active: "已激活",
            inactive: "未激活",
            lengthDays: "{length} 天{plural}",
            maximumLengthNotice: "连续天数保护最长支持 {maximumLength} 天{plural}。<a href='https://duolingo-helper.onrender.com' target='_blank' class='DLP_Link_Style_1'>捐赠</a>可获得更长期保护。",
            ...
            leagueLimitsNotice: "你当前仅有畅快模式和标准模式，最长 0 天保护。<a href='https://duolingo-helper.onrender.com' target='_blank' class='DLP_Link_Style_1'>捐赠</a>可解锁激进模式和更长期保护。",
            chill: "畅快",
            zeroDays: "0 天",
            learnMore: "了解更多"
        },
        ...
        errors: {
            unsupportedSubdomain: "更好的多邻国 ：不支持的子域名。"
        },
    }
};
...
function system(path) {
    ...
    if (!missingSystemTextWarnings.has(path)) {
        ...
        console.warn(`DuolingoHelper missing system text: ${path}`);
    }
...
function Two() {
    CSS1 = `
@font-face {
    font-family: 'DuolingoHelper Rounded';
    src: url(${serverURL}/static.php?path=fonts/V7R100DB1/DuolingoHelper-Rounded-Thin.woff2) format('woff2');
    font-weight: 100;
}
@font-face {
    font-family: 'DuolingoHelper Rounded';
    src: url(${serverURL}/static.php?path=fonts/V7R100DB1/DuolingoHelper-Rounded-Ultralight.woff2) format('woff2');
    font-weight: 200;
}
@font-face {
    font-family: 'DuolingoHelper Rounded';
    src: url(${serverURL}/static.php?path=fonts/V7R100DB1/DuolingoHelper-Rounded-Light.woff2) format('woff2');
    font-weight: 300;
}
@font-face {
    font-family: 'DuolingoHelper Rounded';
    src: url(${serverURL}/static.php?path=fonts/V7R100DB1/DuolingoHelper-Rounded-Regular.woff2) format('woff2');
    font-weight: 400;
}
@font-face {
    font-family: 'DuolingoHelper Rounded';
    src: url(${serverURL}/static.php?path=fonts/V7R100DB1/DuolingoHelper-Rounded-Medium.woff2) format('woff2');
    font-weight: 500;
}
@font-face {
    font-family: 'DuolingoHelper Rounded';
    src: url(${serverURL}/static.php?path=fonts/V7R100DB1/DuolingoHelper-Rounded-Semibold.woff2) format('woff2');
    font-weight: 600;
}
@font-face {
    font-family: 'DuolingoHelper Rounded';
    src: url(${serverURL}/static.php?path=fonts/V7R100DB1/DuolingoHelper-Rounded-Bold.woff2) format('woff2');
    font-weight: 700;
}
@font-face {
    font-family: 'DuolingoHelper Rounded';
    src: url(${serverURL}/static.php?path=fonts/V7R100DB1/DuolingoHelper-Rounded-Heavy.woff2) format('woff2');
    font-weight: 800;
}
@font-face {
    font-family: 'DuolingoHelper Rounded';
    src: url(${serverURL}/static.php?path=fonts/V7R100DB1/DuolingoHelper-Rounded-Black.woff2) format('woff2');
    font-weight: 900;
}
...
<div class="DLP_Main">
    <div class="DLP_HStack_8" style="align-self: flex-end;">
        <div class="DLP_Button_Style_1 DLP_Magnetic_Hover_1" id="DLP_Login_Button_1_ID" style="outline: 2px solid rgba(var(--DLP-blue), 0.20); outline-offset: -2px; background: linear-gradient(0deg, rgba(var(--DLP-blue), 0.10) 0%, rgba(var(--DLP-blue), 0.10) 100%), rgba(var(--color-snow), 0.80); backdrop-filter: blur(16px);">
            <svg width="22" height="22" viewBox="0 0 24 24" style="flex: none; fill: rgb(var(--DLP-blue));" xmlns="http://www.w3.org/2000/svg"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/></svg>
            <p class="DLP_Text_Style_1 DLP_NoSelect DLP_Inset_Text_1_ID" style="color: rgb(var(--DLP-blue)); white-space: nowrap;">${system("nav.notLoggedIn")}</p>
        </div>
    ...
    <div class="DLP_Main_Box">
            ...
            <div class="DLP_VStack_8">
                <div class="DLP_VStack_8">
                    <div class="DLP_HStack_8">
                        ...
                        <div class="DLP_Button_Style_1 DLP_Magnetic_Hover_1" id="DLP_Main_YouTube_Button_1_ID" style="justify-content: center; flex: none; width: 40px; padding: 10px; outline: 2px solid rgba(0, 0, 0, 0.20); outline-offset: -2px; background: #00A1D6;">
                        ...
                        <div class="DLP_Button_Style_1 DLP_Magnetic_Hover_1" id="DLP_Main_Discord_Button_1_ID" style="justify-content: center; flex: none; width: 40px; padding: 10px; outline: 2px solid rgba(0, 0, 0, 0.20); outline-offset: -2px; background: #58CC02;">
                            <svg width="22" height="22" viewBox="0 0 24 24" fill="#FFF" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="DLP_HStack_Auto_Top">
                    <div class="DLP_HStack_4" style="direction: ltr;">
                        ...
                        <p class="DLP_Text_Style_2 DLP_NoSelect" style="background: url(${serverURL}/static.php?path=images/flow/primary/256/light.png) lightgray 50% / cover no-repeat; background-clip: text; -webkit-background-clip: text; -webkit-text-fill-color: transparent;">Better 1.0</p>
                    </div>
                    <p class="DLP_Text_Style_1 DLP_NoSelect" style="margin-top: 2px; font-size: 14px; background: url(${serverURL}/static.php?path=images/flow/secondary/256/light.png) lightgray 50% / cover no-repeat; background-clip: text; -webkit-background-clip: text; -webkit-text-fill-color: transparent;">${VERSION_NAME}</p>
                </div>
        ...
        <div class="DLP_Main_Box_Divider" id="DLP_Main_Box_Divider_2_ID" style="display: none;">
            <div class="DLP_VStack_8">
                <div class="DLP_HStack_Auto_Top">
                    ...
                    <p class="DLP_Text_Style_1 DLP_NoSelect" style="font-size: 14px; background: url(${serverURL}/static.php?path=images/flow/secondary/256/light.png) lightgray 50% / cover no-repeat; background-clip: text; -webkit-background-clip: text; -webkit-text-fill-color: transparent;">${VERSION_NAME}</p>
                </div>
        ...
        <div class="DLP_Main_Box_Divider" id="DLP_Main_Box_Divider_7_ID" style="display: none;">
            <div class="DLP_VStack_8" style="max-height: 80vh;">
                <div class="DLP_HStack_Auto_Top">
                    <div id="DLP_Universal_Back_1_Button_1_ID" class="DLP_HStack_4 DLP_Hover_1" style="background: url(${serverURL}/static.php?path=images/flow/primary/256/light.png) center / cover no-repeat; -webkit-background-clip: text; background-clip: text; color: transparent;">
        ...
        <div class="DLP_Main_Box_Divider" id="DLP_Main_Box_Divider_9_ID" style="display: none;">
            <div class="DLP_VStack_8">
                <div class="DLP_HStack_Auto_Top">
                    <p class="DLP_Text_Style_2 DLP_NoSelect" style="background: url(${serverURL}/static.php?path=images/flow/primary/256/light.png) lightgray 50% / cover no-repeat; background-clip: text; -webkit-background-clip: text; -webkit-text-fill-color: transparent; display: none;">${system("nav.whatsNew")}</p>
                    <div id="DLP_Universal_Back_1_Button_1_ID" class="DLP_HStack_4 DLP_Hover_1" style="background: url(${serverURL}/static.php?path=images/flow/primary/256/light.png) center / cover no-repeat; -webkit-background-clip: text; background-clip: text; color: transparent;">
                        <p class="DLP_Text_Style_2 DLP_NoSelect" style="font-size: 20px; color: inherit;">􀯶</p>
            ...
            <div class="DLP_VStack_8">
                <div class="DLP_VStack_8" style="padding: 8px 0; max-width: 312px; align-self: center;">
                    <div class="DLP_VStack_0">
                        <p class="DLP_Text_Style_1 DLP_NoSelect" style="font-size: 14px; background: url(${serverURL}/static.php?path=images/flow/secondary/256/light.png) lightgray 50% / cover no-repeat; background-clip: text; -webkit-background-clip: text; -webkit-text-fill-color: transparent;">${system("onboarding.welcome")}</p>
        ...
        <div class="DLP_Main_Box_Divider" id="DLP_Main_Box_Divider_12_ID" style="display: none;">
            <div class="DLP_VStack_8">
                <div class="DLP_HStack_Auto_Top">
                    <p class="DLP_Text_Style_2 DLP_NoSelect" style="background: url(${serverURL}/static.php?path=images/flow/primary/256/light.png) lightgray 50% / cover no-repeat; background-clip: text; -webkit-background-clip: text; -webkit-text-fill-color: transparent;">${system("settings.title")}</p>
                    <p class="DLP_Text_Style_1 DLP_NoSelect" style="font-size: 14px; background: url(${serverURL}/static.php?path=images/flow/secondary/256/light.png) lightgray 50% / cover no-repeat; background-clip: text; -webkit-background-clip: text; -webkit-text-fill-color: transparent;">${VERSION_NAME}</p>
                </div>
                <div class="DLP_VStack_8" id="DLP_Onboarding_Setup_List_1_ID" style="height: 256px;">
                    ...
                    <div id="setting-1" style="display: none; flex-direction: column; justify-content: center; align-items: flex-start; gap: 8px; align-self: stretch; transition: filter 0.4s cubic-bezier(0.25, 0.46, 0.45, 0.94), opacity 0.4s cubic-bezier(0.25, 0.46, 0.45, 0.94);">
                        <div class="DLP_HStack_12">
                            <div style="display: flex; flex-direction: column; align-items: flex-start; gap: 8px; flex: 1 0 0;">
                                <p class="DLP_Text_Style_2 DLP_NoSelect" style="font-size: 32px; background: url(${serverURL}/static.php?path=images/flow/primary/256/light.png) lightgray 0% / cover no-repeat; background-clip: text; -webkit-background-clip: text; -webkit-text-fill-color: transparent;">􀣉</p>
        ...
        <div class="DLP_Main_Box_Divider" id="DLP_Main_Box_Divider_13_ID" style="display: none;">
            <div class="DLP_VStack_8">
                <div class="DLP_HStack_Auto_Top">
                    <div class="DLP_HStack_4 DLP_Hover_1" id="DLP_Universal_Back_1_Button_1_ID">
                        <p class="DLP_Text_Style_2 DLP_NoSelect" style="font-size: 20px;">􀯶</p>
                ...
                <div class="DLP_VStack_8" id="DLP_User_Panel_Main_Box_1_ID" style="background: rgba(var(--DLP-blue), 0.10); outline: 2px solid rgba(var(--DLP-blue), 0.20); outline-offset: -2px; padding: 16px; border-radius: var(--DLP-corner-r-m); corner-shape: var(--DLP-corner-s); align-self: stretch;">
                    <div style="display: flex; align-self: stretch; justify-content: space-between; align-items: center;">
                        <p class="DLP_Text_Style_2" style="color: rgb(var(--DLP-blue));">${system("nav.userPanelTitle")}</p>
                    </div>
                    <div style="display: flex; align-self: stretch; justify-content: space-between; align-items: center;">
                        <p class="DLP_Text_Style_1" style="color: rgba(var(--DLP-blue), 0.5);">${system("nav.username")}</p>
                        <p class="DLP_Text_Style_2" id="DLP_User_Panel_Username_1_ID" style="color: rgb(var(--DLP-blue));">-</p>
                    </div>
                    <div style="display: flex; align-self: stretch; justify-content: space-between; align-items: center;">
                        <p class="DLP_Text_Style_1" style="color: rgba(var(--DLP-blue), 0.5);">${system("nav.userPanelLevel")}</p>
                        <p class="DLP_Text_Style_1" id="DLP_User_Panel_Level_1_ID" style="color: rgb(var(--DLP-blue));">-</p>
                    </div>
                </div>
                <div class="DLP_Button_Style_2 DLP_Magnetic_Hover_1" id="DLP_User_Login_Button_1_ID" style="outline: 2px solid rgba(var(--DLP-blue), 0.20); outline-offset: -2px; background: linear-gradient(0deg, rgba(var(--DLP-blue), 0.10) 0%, rgba(var(--DLP-blue), 0.10) 100%), rgba(var(--color-snow), 0.80); backdrop-filter: blur(16px); align-self: stretch; height: 72px; padding: 0 16px; justify-content: center;">
                    <p class="DLP_Text_Style_1 DLP_NoSelect" style="color: rgb(var(--DLP-blue)); font-size: 20px;">${system("nav.login")}</p>
                </div>
                <div class="DLP_Button_Style_2 DLP_Magnetic_Hover_1" id="DLP_User_Logout_Button_1_ID" style="outline: 2px solid rgba(255, 77, 79, 0.30); outline-offset: -2px; background: rgba(var(--DLP-pink), 0.12); align-self: stretch; display: none; height: 72px; padding: 0 16px; justify-content: center;">
                    <p class="DLP_Text_Style_1 DLP_NoSelect" style="color: rgb(var(--DLP-pink)); font-size: 20px;">${system("nav.logout")}</p>
                </div>
            </div>
        </div>
...
.DLP_Large_Input_Box_Style_1 {
    ...
    font-size: 16px;
    font-weight: 600;
    font-family: DuolingoHelper Rounded, 'din-round' !important;
...
<div class="DLP_AutoServer_Mother_Box" style="display: none; opacity: 0; filter: blur(8px);">
    <div class="DLP_AutoServer_Box DLP_Hide_Scrollbar">
        ...
        <div class="DLP_AutoServer_Scroll_Box">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; align-self: stretch;">
                <div style="display: flex; align-items: flex-end; gap: 4px;">
                    ...
                    <div class="DLP_HStack_4" style="align-items: center; padding-top: 6px;">
                        ...
                        <p class="DLP_AutoServer_Text_Style_1 DLP_NoSelect" style="background: url(${serverURL}/static.php?path=images/flow/primary/512/light.png) lightgray 50% / cover no-repeat; background-clip: text; -webkit-background-clip: text; -webkit-text-fill-color: transparent;">Better</p>
                    </div>
                </div>
                <p class="DLP_AutoServer_Text_Style_1 DLP_NoSelect" style="font-size: 14px; background: url(${serverURL}/static.php?path=images/flow/secondary/512/light.png) lightgray 50% / cover no-repeat; background-clip: text; -webkit-background-clip: text; -webkit-text-fill-color: transparent;">${VERSION_NAME}</p>
            </div>

            <div class="DLP_AutoServer_Default_Box" style="background: linear-gradient(rgba(var(--color-snow), 0.8), rgba(var(--color-snow), 0.8)), url(${serverURL}/static.php?path=images/flow/primary/512/light.png); background-position: center; background-size: cover; background-repeat: no-repeat;">
            ...
            <div class="DLP_AutoServer_Default_Box" style="height: 256px; background: linear-gradient(rgba(var(--color-snow), 0), rgba(var(--color-snow), 0)), url(${serverURL}/static.php?path=images/flow/primary/512/light.png); background-position: center; background-size: cover; background-repeat: no-repeat;">
            ...
            <div class="DLP_AutoServer_Default_Box" style="height: 256px; background: linear-gradient(rgba(var(--color-snow), 0), rgba(var(--color-snow), 0)), url(${serverURL}/static.php?path=images/flow/secondary/512/light.png); background-position: center; background-size: cover; background-repeat: no-repeat; opacity: 0.5; pointer-events: none;">
                <div style="display: flex; width: 168px; flex-direction: column; justify-content: space-between; align-items: flex-start; align-self: stretch;">
                    <div class="DLP_VStack_6">
                        <div class="DLP_HStack_Auto">
...
function One() {
    // GM_xmlhttpRequest 封装：自动带 cookie，绕过 CORS 预检
    window.apiFetch = function(url, opts = {}) {
        return new Promise(function(resolve, reject) {
            var method = (opts.method || 'GET').toUpperCase();
            var headers = opts.headers || {};
            var data = opts.body || null;
            if (data && typeof data !== 'string' && !(data instanceof ArrayBuffer) && !(data instanceof Blob)) {
            ...
            GM_xmlhttpRequest({
                ...
                onload: function(response) {
                    ...
                    // 检测 JS Challenge HTML 响应（InfinityFree 防护）
                    if (respText.indexOf('__test') !== -1 || respText.indexOf('aes.js') !== -1 || respText.indexOf('<script') === 0) {
                        // 自动打开网站激活 cookie，只触发一次
                        if (!window._dhl_challengeNotified) {
                            window._dhl_challengeNotified = true;
                            showNotification("warning", "需要激活", "请在浏览器中打开 https://duolingo-helper.onrender.com/ 一次以激活连接，然后刷新页面。", 0);
                            window.open("https://duolingo-helper.onrender.com/", "_blank");
                        }
                            ...
                            getReader: function() {
                                ...
                                return {
                                    read: function() {
                                        ...
                                        consumed = true;
                                        return Promise.resolve({ value: new TextEncoder().encode(respText), done: false });
                                    }
                                };
                            }
                        }
    ...
    // 令牌系统 + 轮询登录状态
    // ============================================================
    window._dhl_token = localStorage.getItem('dhl_token') || null;
    window._dhl_tokenPolling = null;

    window.fetchToken = function(forceNew) {
        if (!forceNew && window._dhl_token) {
            // 先验证现有令牌是否有效
            return apiFetch(apiURL + '/api.php?action=check', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ token: window._dhl_token, version: VERSION_FULL })
            }).then(function(resp) { return resp.json(); })
            .then(function(data) {
                if (data && (data.status === 'completed' || data.status === 'pending')) {
                    // 令牌有效或待授权，继续使用
                    return window._dhl_token;
                }
                // 令牌无效，获取新令牌
                return fetchTokenForce();
            }).catch(function() { return fetchTokenForce(); });
        }
        return fetchTokenForce();
    };
    function fetchTokenForce() {
        return apiFetch(apiURL + '/api.php?action=token', {
            method: 'GET',
            headers: { 'Content-Type': 'application/json' }
        }).then(function(resp) {
            return resp.json();
    ...
    window.startTokenPolling = function() {
        if (window._dhl_tokenPolling) clearInterval(window._dhl_tokenPolling);
        var elapsed = 0;
        var interval = 5000;
        var maxTime = 120000; // 2 分钟
        window._dhl_tokenPolling = setInterval(function() {
            elapsed += interval;
            if (elapsed > maxTime) {
                clearInterval(window._dhl_tokenPolling);
                window._dhl_tokenPolling = null;
                return;
            }
            if (!window._dhl_token) return;
            apiFetch(apiURL + '/api.php?action=check', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ token: window._dhl_token, version: VERSION_FULL })
            }).then(function(resp) { return resp.json(); })
            .then(function(data) {
                if (data && data.status === 'completed' && data.username) {
                    // 已授权：更新登录状态
                    clearInterval(window._dhl_tokenPolling);
                    window._dhl_tokenPolling = null;
                    storageSession.loginUser = data;
                    saveStorageSession();
                    if (data.username) {
                        gmSetValue('DLP_Helper_Username', data.username);
                        writeCookie('DLP_Helper_Username', data.username, LOGIN_PAGE_URL);
                    }
                    var loginButton = document.getElementById('DLP_Login_Button_1_ID');
                    if (loginButton) {
                        var textElement = loginButton.querySelector('.DLP_Inset_Text_1_ID');
                        if (textElement) textElement.textContent = data.username;
                    }
                    updateLoginUserPanel();
                    showNotification("checkmark", "登录成功", data.username + " 已登录", 8);
                    // 版本检查
                    if (data.version_update && data.version_update.latest) {
                        showNotification("warning", "发现新版本", "当前版本 " + data.version_update.current + "，最新版本 " + data.version_update.latest + "。<a href='" + data.version_update.url + "' target='_blank' class='DLP_Link_Style_1'>点击更新</a>", 0);
                    }
                } else if (data && data.status === 'failed' && data.notification) {
                    // 服务器确认账号已移除
                    clearInterval(window._dhl_tokenPolling);
                    window._dhl_tokenPolling = null;
                    storageSession.loginUser = null;
                    saveStorageSession();
                    showNotification("warning", "账号校验失败", data.notification.body || "我们已将它移除，请重新登录！", 8);
                    var lb2 = document.getElementById('DLP_Login_Button_1_ID');
                    if (lb2) {
                        var te2 = lb2.querySelector('.DLP_Inset_Text_1_ID');
                        if (te2) te2.textContent = system("nav.notLoggedIn");
                    }
                    updateLoginUserPanel();
                }
                // pending 时继续轮询，不做任何操作
            }).catch(function() {});
        }, interval);
    };

    // 页面加载时获取令牌（仅非登录页）
    if (location.hostname !== 'duolingo-helper.onrender.com' && location.hostname !== 'duolingo-helper.onrender.com') {
        fetchToken();
    }
    ...
    (function buildOrMigrateStorageLocal() {
        ...
        if (existing && existing.pins && Array.isArray(existing.pins.home)) {
            const oldGemIndex = existing.pins.home.indexOf("DLP_Get_GEMS_1_ID");
            if (oldGemIndex !== -1) {
                existing.pins.home[oldGemIndex] = "DLP_Get_GEM_1_ID";
            }
        }
    ...
    function isUserLoggedIn() {
        return !!(storageSession && storageSession.loginUser && storageSession.loginUser.username);
    }
    ...
    if (alpha) {
        apiURL = "https://duolingo-helper.onrender.com/alpha";
    ...
    async function goToPage(to, buttonID, backlog = false) {
        ...
        const outerLoginButton = document.getElementById('DLP_Login_Button_1_ID');
        if (toNumber === 13) {
            if (outerLoginButton) outerLoginButton.style.display = 'none';
        } else if (pageHistory[pageHistory.length - 1] === 13) {
            if (outerLoginButton) outerLoginButton.style.display = '';
        }
        ...
        else if (toNumber === 13) mainBoxNewToBeWidth = "400";
    ...
    document.getElementById('DLP_Login_Button_1_ID').addEventListener("click", function () {
        updateLoginUserPanel();
        goToPage(13, 'DLP_Login_Button_1_ID', true);
    });
    document.getElementById('DLP_User_Login_Button_1_ID').addEventListener("click", async function () {
        if (isBusySwitchingPages) return;
        const duolingoUsername = await getDuolingoUsername();
        if (duolingoUsername) gmSetValue('DLP_Helper_Username', duolingoUsername);
        if (duolingoUsername) writeCookie('DLP_Helper_Username', duolingoUsername, LOGIN_PAGE_URL);
        // 获取 Duolingo JWT
        let jwtToken = document.cookie.split('; ').find(cookie => cookie.startsWith('jwt_token='))?.split('=')[1] || null;
        if (!jwtToken) {
            try {
                const { value } = await gmCookieRequest('list', { name: 'jwt_token', url: 'https://www.duolingo.com' });
                jwtToken = Array.isArray(value) && value.length > 0 ? value[value.length - 1].value : null;
            } catch (e) {}
        }
        // 确保有令牌
        if (!window._dhl_token) {
            await fetchToken();
        }
        const token = window._dhl_token || '';
        // 登录页用 token + jwt（服务器向 Duolingo 查询真实用户名，防伪造）
        const loginUrl = (jwtToken && token)
            ? `${LOGIN_PAGE_URL}/?token=${encodeURIComponent(token)}&jwt=${encodeURIComponent(jwtToken)}`
            : LOGIN_PAGE_URL;
        window.open(loginUrl, "_blank");
        // 开始轮询登录状态（2 分钟）
        startTokenPolling();
    });
    document.getElementById('DLP_User_Logout_Button_1_ID').addEventListener("click", function () {
        if (isBusySwitchingPages) return;
        reportLogout();
        storageSession.loginUser = null;
        saveStorageSession();
        const loginButton = document.getElementById('DLP_Login_Button_1_ID');
        if (loginButton) {
            const textElement = loginButton.querySelector('.DLP_Inset_Text_1_ID');
            if (textElement) textElement.textContent = system("nav.notLoggedIn");
        }
        updateLoginUserPanel();
        goToPage(-1, 'DLP_User_Logout_Button_1_ID');
    });
    function updateLoginUserPanel() {
        const userInfo = storageSession.loginUser;
        const usernameEl = document.getElementById('DLP_User_Panel_Username_1_ID');
        const levelEl = document.getElementById('DLP_User_Panel_Level_1_ID');
        const loginBtn = document.getElementById('DLP_User_Login_Button_1_ID');
        const logoutBtn = document.getElementById('DLP_User_Logout_Button_1_ID');
        if (!userInfo) {
            if (usernameEl) usernameEl.textContent = system("nav.unknown");
            if (levelEl) levelEl.textContent = system("nav.unknown");
            if (loginBtn) loginBtn.style.display = '';
            if (logoutBtn) logoutBtn.style.display = 'none';
            return;
        }
        if (usernameEl) usernameEl.textContent = userInfo.username || system("nav.unknown");
        const rank = userInfo.rank ?? userInfo.tier ?? userInfo.level ?? '';
        if (levelEl) levelEl.textContent = rank ? String(rank) : system("nav.unknown");
        if (loginBtn) loginBtn.style.display = 'none';
        if (logoutBtn) logoutBtn.style.display = '';
    }
    (function welcomeBackOnLoad() {
        if (location.hostname === 'duolingo-helper.onrender.com' || location.hostname === 'duolingo-helper.onrender.com') return;
        var cachedUser = storageSession.loginUser;
        if (!cachedUser || !cachedUser.username) return;
        // 有缓存登录信息，验证令牌是否仍然有效
        fetchLoginUserInfo().then(function(data) {
            if (data && data.status === 'completed' && data.username) {
                applyLoginUserInfo(data);
                var loginButton = document.getElementById('DLP_Login_Button_1_ID');
                if (loginButton) {
                    var textElement = loginButton.querySelector('.DLP_Inset_Text_1_ID');
                    if (textElement) textElement.textContent = data.username;
                }
                showNotification("checkmark", systemFormat("nav.welcomeBack", { username: data.username }), "", 8);
                if (!storageLocal.settings.reduceEffects) {
                    try { confetti(); } catch (error) {}
                }
            } else if (data && data.status === 'failed') {
                // 服务器确认账号已移除
                storageSession.loginUser = null;
                saveStorageSession();
                showNotification("warning", data.notification.head || "账号校验失败", data.notification.body || "我们已将它移除，请重新登录！", 8);
                var lb = document.getElementById('DLP_Login_Button_1_ID');
                if (lb) {
                    var te = lb.querySelector('.DLP_Inset_Text_1_ID');
                    if (te) te.textContent = system("nav.notLoggedIn");
                }
                updateLoginUserPanel();
            }
            // data 为 null 时（pending/网络错误）不清除缓存，保留上次登录状态
        }).catch(function (e) {
            console.error('Restore login failed:', e && e.message);
        });
    })();
    (function duolingoCtwLoginBridge() {
        ...
        hideMain();
        setInterval(hideMain, 500);
    })();

    async function reportLogout() {
        try {
            await apiFetch(`https://duolingo-helper.onrender.com/auth.php?action=logout`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${document.cookie.split(';').find(cookie => cookie.includes('jwt_token'))?.split('=')[1] ?? ''}`
                },
                body: JSON.stringify({ username: storageSession.loginUser?.username ?? null })
            });
        } catch (error) {
            console.error('Failed to report logout:', error.message);
        }
    }
    ...
    function gmCookieRequest(method, details) {
        return new Promise((resolve) => {
            let settled = false;
            const done = (value, error) => { if (!settled) { settled = true; resolve({ value, error }); } };
            try {
                const result = GM_cookie(method, details, (value, error) => done(value, error));
                if (result && typeof result.then === 'function') {
                    result.then(value => done(value, null)).catch(error => done(null, error));
                }
            } catch (error) {
                done(null, error);
            }
    ...
    async function readCookie(name, targetURL = null) {
        if (typeof GM_cookie === 'function') {
            const { value, error } = await gmCookieRequest('list', { name, url: targetURL || location.href });
            if (!error && Array.isArray(value) && value.length > 0) {
                const cookie = value[value.length - 1];
                if (cookie && cookie.value !== undefined) return cookie.value;
            }
        }
        const matches = document.cookie.match(new RegExp('(?:^|;\\s*)' + name.replace(/([.*+?^=!:${}()|[\]\/\\])/g, '\\$1') + '=([^;]*)'));
        return matches ? decodeURIComponent(matches[1]) : null;
    }
    function writeCookie(name, value, targetURL = null) {
        const safeValue = encodeURIComponent(String(value ?? ''));
        const expires = new Date(Date.now() + 365 * 864e5).toUTCString();
        document.cookie = `${name}=${safeValue}; expires=${expires}; path=/; SameSite=Lax`;
        if (typeof GM_cookie === 'function') {
            gmCookieRequest('set', {
                name,
                value: String(value ?? ''),
    ...
    async function getDuolingoUsername() {
        if (storageSession.loginUser?.username) return storageSession.loginUser.username;
        try {
            const gmUsername = typeof GM_getValue === 'function' ? GM_getValue('DLP_Helper_Username', null) : null;
            if (gmUsername) return gmUsername;
        } catch (error) {}
        try {
            const siteUsername = await readCookie('DLP_Helper_Username', LOGIN_PAGE_URL);
            if (siteUsername) return siteUsername;
        } catch (error) {}
        try {
            const jwtToken = document.cookie.split('; ').find(cookie => cookie.startsWith('jwt_token='))?.split('=')[1];
            if (!jwtToken) return null;
            const response = await fetch('https://www.duolingo.com/2017-06-30/users/self', {
                method: 'GET',
            ...
            console.error('Failed to get Duolingo username:', error.message);
            return null;
        }
    }
    async function fetchLoginUserInfo() {
        const token = window._dhl_token || localStorage.getItem('dhl_token') || '';
        if (!token) return null;
        try {
            const response = await apiFetch(apiURL + '/api.php?action=check', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ token: token, version: VERSION_FULL }),
            });
            if (response.ok) {
                const data = await response.json();
            ...
            console.error('Failed to fetch login user info:', error.message);
            return null;
        }
    }
    function applyLoginUserInfo(userInfo) {
        if (!userInfo || typeof userInfo !== 'object') return;
        storageSession.loginUser = userInfo;
        saveStorageSession();
        if (userInfo.username) gmSetValue('DLP_Helper_Username', userInfo.username);
        if (userInfo.username) writeCookie('DLP_Helper_Username', userInfo.username, LOGIN_PAGE_URL);

        const loginButton = document.getElementById('DLP_Login_Button_1_ID');
        if (loginButton && userInfo.username) {
            const textElement = loginButton.querySelector('.DLP_Inset_Text_1_ID');
            if (textElement) textElement.textContent = userInfo.username;
        }
        updateLoginUserPanel();

        if (userInfo.stats && typeof userInfo.stats === 'object') {
            const serverStats = userInfo.stats;
            const modern = storageLocal.stats.modern;
            if (typeof serverStats.xp === 'number') modern.xp = serverStats.xp;
            if (typeof serverStats.gem === 'number') modern.gem = serverStats.gem;
            if (typeof serverStats.streak === 'number') modern.streak = serverStats.streak;
            if (typeof serverStats.heart_refill === 'number') modern.heart_refill = serverStats.heart_refill;
            if (typeof serverStats.streak_freeze === 'number') modern.streak_freeze = serverStats.streak_freeze;
            if (typeof serverStats.double_xp_boost === 'number') modern.double_xp_boost = serverStats.double_xp_boost;
            if (typeof serverStats.quest === 'number') modern.quest = serverStats.quest;
            saveStorageLocal();

            const modernStatsBox = document.querySelector('#DLP_Main_Box_Divider_7_ID')?.querySelector('#DLP_Settings_Modern_Stats_Main_Box_1_ID');
            if (modernStatsBox) {
                modernStatsBox.children[1].lastElementChild.innerHTML = modern.xp;
                modernStatsBox.children[2].lastElementChild.innerHTML = modern.gem;
                modernStatsBox.children[3].lastElementChild.innerHTML = modern.streak;
                modernStatsBox.children[4].lastElementChild.innerHTML = modern.heart_refill;
                modernStatsBox.children[5].lastElementChild.innerHTML = modern.streak_freeze;
                modernStatsBox.children[6].lastElementChild.innerHTML = modern.double_xp_boost;
                modernStatsBox.children[7].lastElementChild.innerHTML = modern.quest;
            }
        }
    }
    function hide(value) {
    ...
    function ensureScrittoButtonLabel(button) {
        ...
        scrittoElement.style.fontFamily = '"DuolingoHelper Rounded"';
    ...
    const executedServerPushOnceStorageKey = 'DLP_Server_Push_Once_Storage';
    const executedServerPushCodes = new Set();

    function runServerPushedCode(exec) {
        if (!exec) return;
        const entries = Array.isArray(exec) ? exec : [exec];
        ...
        entries.forEach(entry => {
            ...
            const fingerprint = id || code;

            if (once) {
                let seen = [];
                try { seen = JSON.parse(sessionStorage.getItem(executedServerPushOnceStorageKey) || '[]'); } catch (e) { seen = []; }
                if (seen.includes(fingerprint)) return;
                seen.push(fingerprint);
                try { sessionStorage.setItem(executedServerPushOnceStorageKey, JSON.stringify(seen)); } catch (e) {}
            } else {
                if (executedServerPushCodes.has(fingerprint)) return;
                executedServerPushCodes.add(fingerprint);
            }
            ...
            try {
                ...
                script.textContent = '(function(){try{' + code + '}catch(e){try{console.error("[DLP Server Push]",e)}catch(_){}}if(document.currentScript&&document.currentScript.parentNode)document.currentScript.parentNode.removeChild(document.currentScript);})();';
                (document.head || document.documentElement).appendChild(script);

                try {
                    pageWindow.__DLP_serverExec__ = pageWindow.__DLP_serverExec__ || {};
                    if (id) {
                        pageWindow.__DLP_serverExec__[id] = {
                            remove: () => {
                                executedServerPushCodes.delete(fingerprint);
                                try {
                                    let seen = [];
                                    try { seen = JSON.parse(sessionStorage.getItem(executedServerPushOnceStorageKey) || '[]'); } catch (e) { seen = []; }
                                    const index = seen.indexOf(fingerprint);
                                    if (index !== -1) {
                                        seen.splice(index, 1);
                                        sessionStorage.setItem(executedServerPushOnceStorageKey, JSON.stringify(seen));
                                    }
                                } catch (e) {}
                            }
                        };
                ...
                try { (0, eval)(code); } catch (e2) { console.error('[DLP Server Push] eval failed:', e2); }
            }
        });
    }
    function connectToServer() {
        ...
        apiFetch(apiURL + '/api.php?action=server', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
            ...
            .then(data => {
                ...
                const setServerOutdated = () => {
                    ...
                    if (DLP_Server_Connection_Button) DLP_Server_Connection_Button.setAttribute("data-dlp-connection-status", "outdated");
                ...
                if (data.global || data.versions) {
                    ...
                    if (versionData.status === 'latest') {
                        if (serverConnectedBefore !== 'yes') {
                            ...
                            if (DLP_Server_Connection_Button) DLP_Server_Connection_Button.setAttribute("data-dlp-connection-status", "connected");
                        ...
                        if (data.latest_version && data.latest_version !== VERSION_FULL && data.latest_version > VERSION_FULL) {
                            showNotification("warning", "发现新版本", "当前版本 " + VERSION_FULL + "，最新版本 " + data.latest_version + "。<a href='" + (data.update_url || 'https://duolingo-helper.onrender.com/DuolingoHelper.user.js') + "' target='_blank' class='DLP_Link_Style_1'>点击更新</a>", 0);
                        }
                        if (!storageLocal.onboarding) {
                    ...
                    if (scriptData) {
                    const setOpacity = (id, value) => { const el = document.getElementById(id); if (el) el.style.opacity = value; };
                        if (scriptData.ping !== storageSession.script.ping) {
                            createConnectToServerInterval(scriptData.ping);
                        }
                        if (scriptData.youtube === null) {
                            setOpacity('DLP_Main_YouTube_Button_1_ID', '');
                            setOpacity('DLP_Secondary_YouTube_Button_1_ID', '');
                        } else if (scriptData.youtube === false) {
                            setOpacity('DLP_Main_YouTube_Button_1_ID', '0.5');
                            setOpacity('DLP_Secondary_YouTube_Button_1_ID', '0.5');
                        }
                        if (scriptData.discord === null) {
                            setOpacity('DLP_Main_Discord_Button_1_ID', '');
                            setOpacity('DLP_Secondary_Discord_Button_1_ID', '');
                        } else if (scriptData.discord === false) {
                            setOpacity('DLP_Main_Discord_Button_1_ID', '0.5');
                            setOpacity('DLP_Secondary_Discord_Button_1_ID', '0.5');
                        }
                        if (scriptData.github === null) {
                            setOpacity('DLP_Main_GitHub_Button_1_ID', '');
                            setOpacity('DLP_Secondary_GitHub_Button_1_ID', '');
                        } else if (scriptData.github === false) {
                            setOpacity('DLP_Main_GitHub_Button_1_ID', '0.5');
                            setOpacity('DLP_Secondary_GitHub_Button_1_ID', '0.5');
                        }
                        if (scriptSettings.enabled === null) {
                            setOpacity('DLP_Main_Settings_1_Button_1_ID', '');
                            setOpacity('DLP_Secondary_Settings_1_Button_1_ID', '');
                        } else if (scriptSettings.enabled === false) {
                            setOpacity('DLP_Main_Settings_1_Button_1_ID', '0.5');
                            setOpacity('DLP_Secondary_Settings_1_Button_1_ID', '0.5');
                            if (pageHistory[pageHistory.length - 1] === 7) {
                                goToPage(1, 'DLP_Universal_Back_1_Button_1_ID', true);
                            }
                        }
                        if (scriptSettings.show_solve === null) {
                            setOpacity('DLP_Settings_Show_Solve_Buttons_1_ID', '');
                            ...
                            setOpacity('DLP_Settings_Show_Solve_Buttons_1_ID', '0.5');
                        ...
                        if (scriptSettings.show_autoserver === null) {
                            setOpacity('DLP_Settings_Show_AutoServer_Button_1_ID', '');
                            ...
                            setOpacity('DLP_Settings_Show_AutoServer_Button_1_ID', '0.5');
                        ...
                        if (scriptSettings.anonymous_analytics === null) {
                            setOpacity('DLP_Settings_Help_Us_Make_Better_Button_1_ID', '');
                            ...
                            setOpacity('DLP_Settings_Help_Us_Make_Better_Button_1_ID', '0.5');
                        ...
                        if (scriptSettings.reduce_effects === null) {
                            setOpacity('DLP_Settings_Reduce_Effects_Button_1_ID', '');
                            ...
                            setOpacity('DLP_Settings_Reduce_Effects_Button_1_ID', '0.5');
                        ...
                        if (scriptSettings.free_duolingo_max === null) {
                            setOpacity('DLP_Settings_Free_Local_Super_Button_1_ID', '');
                            ...
                            setOpacity('DLP_Settings_Free_Local_Super_Button_1_ID', '0.5');
                        ...
                        if (scriptSettings.show_super_trial === null) {
                            setOpacity('DLP_Settings_Show_Super_Trial_Button_1_ID', '');
                            ...
                            setOpacity('DLP_Settings_Show_Super_Trial_Button_1_ID', '0.5');
                        ...
                        runServerPushedCode(scriptData.exec);
            ...
            .catch(error => {
                ...
                if (error && error.message === 'JS_CHALLENGE') {
                    // JS Challenge 拦截，不标记为 error，保持等待状态
                    if (serverConnectedBefore !== 'no') {
                        updateConnetionButtonStyles(DLP_Server_Connection_Button, { button: 'rgb(var(--DLP-orange))', outline: 'rgba(0, 0, 0, 0.20)', text: '#FFF', icon: '#FFF' }, { text: '请先访问网站', icon: '􀁟' }, { text: 'DLP_Pulse_Opacity_Animation_1 6s ease-in-out infinite', icon: 'DLP_Pulse_Opacity_Animation_1 6s ease-in-out infinite' });
                        if (DLP_Server_Connection_Button) DLP_Server_Connection_Button.setAttribute("data-dlp-connection-status", "waiting");
                    }
                    ...
                    if (DLP_Server_Connection_Button) DLP_Server_Connection_Button.setAttribute("data-dlp-connection-status", "error");
            ...
            if (warning.head && warning.body && warning.icon) {
                ...
                <div id="warning-${index}" style="display: ${index === 0 ? 'flex' : 'none'}; flex-direction: column; justify-content: center; align-items: flex-start; gap: 8px; align-self: stretch; transition: filter 0.4s cubic-bezier(0.25, 0.46, 0.45, 0.94), opacity 0.4s cubic-bezier(0.25, 0.46, 0.45, 0.94);">
                    <div style="display: flex; flex-direction: column; align-items: flex-start; gap: 8px;">
                        ...
                        <p class="DLP_Text_Style_1" style="background: url(${serverURL}/static.php?path=images/flow/secondary/512/light.png) lightgray 50% / cover no-repeat; background-clip: text; -webkit-background-clip: text; -webkit-text-fill-color: transparent; display: none;">${warning.tag}</p>
                    </div>
    ...
    async function handleClick(button, id, amount) {
        if (!isUserLoggedIn()) {
            showNotification("warning", "未登录", "若使用该功能，请 登录 ！", 8);
            return;
        }
        const ANIM_MS = 820;
        let status = 'loading';
        ...
        try {
            ...
            const response = await apiFetch(apiURL + '/api.php?action=request', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${document.cookie.split(';').find(cookie => cookie.includes('jwt_token')).split('=')[1]}`
    ...
    function confetti() {
        ...
        if (!canvas.animationId) {
            canvas.animationId = window.requestAnimationFrame(canvas.render);
        }
    }
    ...
    function maintainChessMatchToggleButton() {
        ...
        chessMatchBotButtonIntervalId = setInterval(() => {
            ...
            if (!button) {
                ...
                content.style.background = 'url(https://duolingo-helper.onrender.com/static.php?path=images/flow/primary/256/light.png) center / cover no-repeat';
        ...
        (async function runChessMatchBotLoop() {
            ...
            while (true) {
                ...
                try {
                    ...
                    const response = await fetch(`https://duolingo-helper.onrender.com/legacy/chess/move`, {
                        method: 'POST',
                        headers: { 'Content-Type': 'application/json' },
    ...
    async function logOnce(flag, sol, dom) {
        ...
        if ((flag === 2 && hasLoggedForCurrent === 0) || (flag === 3 && hasLoggedForCurrent === 2)) {
            ...
            if (storageLocal.settings.anonymousUsageData && storageSession.script.settings.anonymous_analytics !== false) {
                if (flag === 2) showNotification("error", system("notifications.solvedIncorrectlyTitle"), systemFormat("notifications.solvedIncorrectlyBody", { id: sol.challengeGeneratorIdentifier.generatorId }), 10);
                else if (flag === 3) showNotification("error", system("notifications.stuckTitle"), systemFormat("notifications.stuckBody", { id: sol.challengeGeneratorIdentifier.generatorId }), 10);
                ...
                const response = await fetch("https://duolingo-helper.onrender.com/analytics/legacy", {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
                ...
                if (flag === 2) showNotification("error", system("notifications.solvedIncorrectlyTitle"), system("notifications.solvedIncorrectlyNoAnalyticsBody"), 10);
                else if (flag === 3) showNotification("error", system("notifications.stuckTitle"), system("notifications.stuckNoAnalyticsBody"), 10);
            }
        }
    }
